 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "mobileaccounting.com", ownerName = "mobileaccounting.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyBr58MPHtP-mnFXbMwNTBCittt8oqFAKUI";
